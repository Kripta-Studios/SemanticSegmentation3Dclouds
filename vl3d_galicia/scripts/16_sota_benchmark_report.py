...
def _write_markdown(
    ...
    lines.extend(
        [
            ...
            "",
            "```powershell",
            "python scripts\\03_train_baseline.py --data data/processed/galicia_blocks_medium_tw --out outputs/local_context_medium/geom_concat_h256_labelblindval_seed7 --epochs 45 --batch-size 24 --num-workers 8 --use-tw-input --base-feature-dir data/processed/galicia_blocks_medium_geom_context --base-feature-key geom_features --fusion-type concat --probe-type mlp --hidden-dim 256 --embed-dim 384 --dropout 0.15 --seed 7 --data-selection-seed 20260714 --class-weight-mode inverse_sqrt --max-class-weight 20.0 --loss-type focal --focal-gamma 1.5 --balanced-sampler --sampler-alpha 1.2 --sampler-max-weight 10.0 --sampler-class-boost 1:1.5,2:2.0,4:4.0 --early-stopping-patience 10 --early-stopping-min-delta 0.001 --max-train-blocks 12000 --max-val-blocks 2000 --train-block-selection class_balanced --val-block-selection random --test-block-selection random",
            "```",
            "",
